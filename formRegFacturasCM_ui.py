...
"border-radius:5px;")
        ...
        self.btnSalir.setGeometry(QRect(390, 440, 150, 40))
        font1 = QFont()
...
"color: rgb(216, 224, 236);")
        ...
        self.cmbTipoCuota.setGeometry(QRect(30, 130, 171, 30))
...
"border-radius:5px;")
        ...
        self.label_4.setGeometry(QRect(30, 110, 81, 16))
        ...
        self.label_3.setGeometry(QRect(450, 0, 151, 16))
        font3 = QFont()
        ...
        self.cmbTipoFact.setGeometry(QRect(310, 130, 211, 30))
...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_13.setText(QCoreApplication.translate("Dialog", u" REGISTRO FACTURAS LOCALES COMERCIALES", None))
        self.cmbTipoCuota.setItemText(0, QCoreApplication.translate("Dialog", u"-selecciona una opcion-", None))
        self.cmbTipoCuota.setItemText(1, QCoreApplication.translate("Dialog", u"Cuota Mensual", None))
        self.cmbTipoCuota.setItemText(2, QCoreApplication.translate("Dialog", u"Cuota Deposito Garantia", None))
        self.cmbTipoCuota.setItemText(3, QCoreApplication.translate("Dialog", u"Cuota Anticipada", None))
        self.cmbTipoCuota.setItemText(4, QCoreApplication.translate("Dialog", u"Otras Cuotas", None))
        ...
        self.label_4.setText(QCoreApplication.translate("Dialog", u"Tipo Cuota*", None))
