...
"border-radius:5px;")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_11.setText(QCoreApplication.translate("Dialog", u"  COBRANZA CUOTAS MANTENIMIENTO", None))
        ...
        self.cmbTipoCuota.setItemText(4, QCoreApplication.translate("Dialog", u"Cuota Atrazada", None))
        self.cmbTipoCuota.setItemText(5, QCoreApplication.translate("Dialog", u"Cuota Extraordinaria", None))
        ...
        self.label_12.setText(QCoreApplication.translate("Dialog", u"Tipo Cuota*", None))
